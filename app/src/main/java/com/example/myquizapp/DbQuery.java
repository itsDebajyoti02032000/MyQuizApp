...
import com.example.myquizapp.Models.CatagoryModel;
import com.example.myquizapp.Models.ProfileModel;
...
public class DbQuery {
    ...
    public static List<RankModel>g_user_list = new ArrayList<>();
    ...
    public static void loadCatagories(MyCompleteListener completeListener)
    {
        g_catList.clear();
        g_firestore.collection("QUIZ").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        QueryDocumentSnapshot catListDoc = docList.get("Catagories");
    ...
    {
        loadCatagories(new MyCompleteListener() {
            @Override
    ...
    public  static void loadquestions(MyCompleteListener completeListener)
    {
        ...
        g_firestore.collection("Questions")
                .whereEqualTo("CATAGORY",g_catList.get(g_selected_cat_index).getDocID())
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        {
                           g_question_list.add(new QuestionModel(
    ...
    public static void getTopuser(MyCompleteListener completeListener)
    {
        g_user_list.clear();
