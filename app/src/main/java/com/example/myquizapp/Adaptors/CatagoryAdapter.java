...
import com.example.myquizapp.TestActivity;

import java.util.List;

public class CatagoryAdapter extends BaseAdapter {

    private List<CatagoryModel> catList;

    public CatagoryAdapter(List<CatagoryModel> catList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        noOfTests.setText(String.valueOf( catList.get(i).getNoOfTest()));
        return myView;
    }
}
